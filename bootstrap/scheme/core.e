...
(e1:define (io:write-non-negative-fixnum file fixnum)
  (e0:if-in fixnum (0)
    (io:write-character file (e0:value #\0))
    (io:write-positive-fixnum file fixnum)))
(e1:define (io:write-positive-fixnum file fixnum)
  (e0:if-in fixnum (0)
    (e0:bundle)
    (e0:let (quotient digit) (fixnum:/% fixnum (e0:value 10))
      (e0:let () (io:write-positive-fixnum file quotient)
        (io:write-character file (fixnum:+ (e0:value #\0) digit))))))
...
(state:primitive-set! (e0:value fixnum:/)           (e0:value 2) (e0:value 1) (e0:value #f) (e0:value #f))
(state:primitive-set! (e0:value fixnum:%)           (e0:value 2) (e0:value 1) (e0:value #f) (e0:value #f))
(state:primitive-set! (e0:value fixnum:/%)          (e0:value 2) (e0:value 2) (e0:value #f) (e0:value #f))
...
(e1:define (sexpression:fixed-point? x)
  (sexpression:has-tag? x sexpression:fixed-point-tag))
...
(e1:define (sexpression:eject-fixnum x)
  (e0:if-in (sexpression:fixnum? x) (#f)
    ...
    (sexpression:eject x)))
(e1:define (sexpression:eject-fixed-point x)
  (e0:if-in (sexpression:fixed-point? x) (#f)
    (e1:error (e0:value "sexpression:eject-fixed-point: not a fixed-point"))
    (sexpression:eject x)))
...
(e1:define (sexpression:inject-fixed-point x)
  (sexpression:make sexpression:fixed-point-tag x))
