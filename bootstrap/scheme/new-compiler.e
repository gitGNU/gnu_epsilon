...
(e1:define (anf:write-sorted-variables port variables)
  (anf:write-variables port (list:sort-symbols variables)))
      ...
      (e1:let ((in-lives (dataflow:state-get-in-lives state))
        ...
        (e1:unless (e1:or (dataflow:instruction-begin? instruction)
          ...
          (fio:write-to file "  " (i id)
                        ...
                        "label=\"")
          (fio:write-to file "{")
          (anf:write-sorted-variables file in-lives)
          (fio:write-to file "}\\n")
          (fio:write-to file (i id) ". ")
          (dataflow:write-instruction file (dataflow:state-get-instruction state))
          (fio:write-to file "\\n{")
          (anf:write-sorted-variables file out-lives)
          (fio:write-to file "}")
          (fio:write-to file "\"];\n"))
