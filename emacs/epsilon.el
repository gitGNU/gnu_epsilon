...
;; Copyright (C) 2013, 2016  Luca Saiu
    ...
    `((,(epsilon-at-list-beginning
      ...
      (,(epsilon-at-list-beginning
         (regexp-opt '("e1:begin" "e1:begin1" "e1:begin2" "e1:begin3" "e1:begin-2" "e1:begin-3"
                       ...
                       "e1:while" "e1:do" "e1:doalist" "e1:dobuffer" "e1:dohash" "e1:dolist" "e1:dovector" "e1:doavl" "e1:doset" "e1:domap" "e1:domapr" "e1:dolist-index" "e1:dolist-combinations" "e1:dolist-combinations-fast" "e1:dolist-combinations-up-to" "e1:dolist-combinations-up-to-fast" "e1:dolist-list" "e1:dovector-index" "e1:dotimes" "e1:for"
                       )))
       (1 font-lock-keyword-face))
      (,(epsilon-at-define-nonprocedure-beginning
...
(put 'e1:dolist-combinations 'epsilon-indent-function 1)
(put 'e1:dolist-combinations-fast 'epsilon-indent-function 1)
(put 'e1:dolist-combinations-up-to 'epsilon-indent-function 1)
(put 'e1:dolist-combinations-up-to-fast 'epsilon-indent-function 1)
(put 'e1:dolist-list 'epsilon-indent-function 1)
