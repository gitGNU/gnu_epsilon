    ...
    `((,(epsilon-at-list-beginning
      ...
      (,(epsilon-at-list-beginning
         (regexp-opt '("e1:begin" "e1:begin1" "e1:begin2" "e1:begin3" "e1:begin-2" "e1:begin-3"
                       ...
                       "e1:while" "e1:do" "e1:doalist" "e1:dobuffer" "e1:dohash" "e1:dolist" "e1:dovector" "e1:doavl" "e1:doset" "e1:domap" "e1:domapr" "e1:dolist-index" "e1:dolistcombinations" "e1:dolistcombinationsupto" "e1:dolistlist" "e1:dovector-index" "e1:dotimes" "e1:for"
                       )))
       (1 font-lock-keyword-face))
      (,(epsilon-at-define-nonprocedure-beginning
...
(put 'e1:dolistcombinations 'epsilon-indent-function 1)
(put 'e1:dolistcombinationsupto 'epsilon-indent-function 1)
(put 'e1:dolistlist 'epsilon-indent-function 1)
