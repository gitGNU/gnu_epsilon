...
static void epsilon_primitive_right_shift(epsilon_value *stack){*stack = epsilon_int_to_epsilon_value(epsilon_value_to_epsilon_int(stack[0]) >> epsilon_value_to_epsilon_int(stack[1]));}
...
// FIXME: move away into a separate initialization function.
  ...
  epsilon_initialize_c_primitive("fixnum:right-shift", epsilon_primitive_right_shift, 2, 1);
